...
func flagInit(cfg *Config) {
	flag.StringVar(&(cfg.ConfFile), "config", "redis.conf", "Appoint a config file: such as /etc/redis.conf")
	...
	flag.StringVar(&(cfg.LogDir), "logdir", defaultLogDir, "Set log directory: default is ./")
